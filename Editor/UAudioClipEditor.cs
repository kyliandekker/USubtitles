...
//		static GUIContent s_PlayIcon = null;
//		static GUIContent s_AutoPlayIcon = null;
//		static GUIContent s_PauseIcon = null;
//		static GUIContent s_StopIcon = null;
//		static GUIContent s_LoopIcon = null;
//		static GUIContent s_PlusIcon = null;
//		static GUIContent s_MinusIcon = null;
...
//			s_PlayIcon = EditorGUIUtility.TrIconContent("d_PlayButton", "Play");
//			s_PauseIcon = EditorGUIUtility.TrIconContent("d_PauseButton", "Pause");
//			s_StopIcon = EditorGUIUtility.TrIconContent("d_PreMatQuad", "Stop");
//			s_LoopIcon = EditorGUIUtility.TrIconContent("d_preAudioLoopOff", "Loop on/off");
//			s_PlusIcon = EditorGUIUtility.TrIconContent("d_Toolbar Plus", "Add Marker");
//			s_MinusIcon = EditorGUIUtility.TrIconContent("d_Toolbar Minus", "Remove Marker");
...
//			// Button drawing.
//			if (DrawToolbarButton(ref buttonPos, s_StopIcon))
//				_player.SetState(AudioState.AudioState_Stopped);

//			if (_player.State == AudioState.AudioState_Playing)
//			{
//				if (DrawToolbarButton(ref buttonPos, s_PauseIcon))
//					_player.SetState(AudioState.AudioState_Paused);
//			}
//			else
//			{
//				if (DrawToolbarButton(ref buttonPos, s_PlayIcon))
//					_player.SetState(AudioState.AudioState_Playing, CalculateSamples(_player.WavePosition));
//			}
...
//			if (DrawToolbarButton(ref buttonPos, s_PlusIcon))
//			{
...
//			if (DrawToolbarButton(ref buttonPos, s_MinusIcon))
//			{
